  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        //   ),
        // ),
        customListTile(context, title: "Change PIN / Password"),
        Padding(
        ...
        customListTile(context, title: "Watchlist"),
        customListTile(context, title: "Partner Reports"),
        customListTile(context, title: "Transactions History"),
        customListTile(context, title: "Fact Sheet"),
        customListTile(context, title: "Share Business Link"),
        customListTile(context,
            title: "Search (Searches anything in database)"),
        Padding(
          padding: const EdgeInsets.symmetric(
            vertical: 8,
            horizontal: 18,
